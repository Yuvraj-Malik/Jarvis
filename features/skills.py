...
def gui_action(action, **kwargs): return toolbox.execute_gui_action(action, **kwargs)
def run_command(command): return toolbox.run_terminal_command(command)
def find_setting(query): return toolbox.search_windows_settings(query)
...
tool_list = [
    ...
    get_system_status, gui_action, run_command, find_setting
]
